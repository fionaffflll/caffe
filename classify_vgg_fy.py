...
def get_video_res():
    ...
    val_face_dir = '/home/fiona/EmotiW2016-CNN-RNN-C3D/emotiw_codes/data/Test_qiyi_face_lstm'

    val_video_dir = '/home/fiona/EmotiW2016-CNN-RNN-C3D/emotiw_codes/lstm/Test_videos/Test_vid_Distribute'
